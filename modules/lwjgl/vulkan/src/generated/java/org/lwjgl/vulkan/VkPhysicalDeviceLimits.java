 ...
 * <li>{@code minTexelGatherOffset} &ndash; the minimum offset value for the {@code Offset} or {@code ConstOffsets} image operands of any of the {@code OpImage}*{@code Gather} image instructions.</li>
 * <li>{@code maxTexelGatherOffset} &ndash; the maximum offset value for the {@code Offset} or {@code ConstOffsets} image operands of any of the {@code OpImage}*{@code Gather} image instructions.</li>
